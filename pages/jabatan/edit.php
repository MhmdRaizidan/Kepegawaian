...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-md mx-auto bg-gray-200 text-gray-900 shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4">
        <h2 class="text-2xl font-bold mb-6 text-center text-orange-600">Edit Jabatan</h2>
        ...
        <form action="../../proses/jabatan/edit.php" method="POST" class="p-6">
            ...
            <div class="mb-4">
                <label for="nama_jabatan" class="block text-orange-700 text-sm font-bold mb-2">Departemen</label>
