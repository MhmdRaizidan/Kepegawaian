...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-md mx-auto bg-gray-200 text-gray-900 shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4">
        <h2 class="text-2xl font-bold mb-6 text-center text-orange-600">Tambah Pegawai Baru</h2>
        
        <?php 
        if(isset($_SESSION['error'])) {
            echo '<div class="bg-orange-500 text-white px-4 py-3 rounded mb-4" role="alert">' . 
                 $_SESSION['error'] . 
                 '</div>';
        ...
        <form action="../../proses/pegawai/tambah.php" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <select 
                    ...
                    name="jenis_kelamin" 
                    required 
                    class="shadow border border-orange-500 bg-gray-100 text-gray-900 rounded w-full py-2 px-3 leading-tight focus:outline-none focus:ring-2 focus:ring-orange-400"
                >
            ...
            <div class="flex items-center justify-between">
                <a 
                    href="index.php" 
                    class="text-orange-600 hover:text-orange-500 font-bold text-sm"
                >
                    Kembali
                </a>
                <button 
                    type="submit" 
                    class="bg-orange-600 hover:bg-orange-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-orange-400"
                >
                    Tambah Pegawai
                </button>
            </div>
